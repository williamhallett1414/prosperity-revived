    ...
    return (
      <div className="min-h-screen bg-[#F2F6FA] dark:bg-[#0A1A2F] flex items-center justify-center">
        <div className="text-center">
          <p className="text-[#0A1A2F]/60 dark:text-white/60 mb-4">Challenge not found</p>
        ...
        <motion.div
          ...
          <div className="bg-white/20 rounded-xl p-3">
              ...
              <div className="h-2 bg-white/30 rounded-full overflow-hidden">
                <div
                className="h-full bg-white dark:bg-white/5 transition-all duration-500"
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            ...
            <div>
                  <div className="bg-gradient-to-r from-emerald-50 to-[#F2F6FA] rounded-xl p-4 mb-4">
                    <h4 className="font-bold text-[#0A1A2F] dark:text-white mb-2">{recommendedWorkout.title}</h4>
                    <div className="flex items-center gap-4 text-sm text-[#0A1A2F]/70 dark:text-white/70">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {selectedDayTask &&
                <p className="text-sm text-[#0A1A2F]/60 dark:text-white/60 mt-2">{selectedDayTask.description}</p>
                }
                  </div>
                  <Button
            ...
            <p className="text-[#0A1A2F]/60 dark:text-white/60 text-sm">No workout assigned for this day.</p>
            }
            </div>
          </motion.div>
        }
            ...
            <div className="bg-white dark:bg-white/5 rounded-xl p-6 shadow-sm dark:shadow-none border border-gray-200 dark:border-white/10 dark:border-white/10">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-[#0A1A2F]/60 dark:text-white/60">Total Check-ins</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#C9A227]">{longestStreak}</div>
                  <div className="text-xs text-[#0A1A2F]/60 dark:text-white/60">Longest Streak</div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-white/5 rounded-xl p-6 shadow-sm dark:shadow-none border border-gray-200 dark:border-white/10 dark:border-white/10">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 dark:bg-white/5 dark:text-white rounded-xl p-4">
                  ...
                  <div className="text-2xl font-bold text-[#0A1A2F] dark:text-white dark:text-white">{userParticipation?.calories_burned || 0}</div>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55 }}>
          ...
          'bg-white dark:bg-white/5 border-gray-200 dark:border-white/10 dark:border-white/10'}`
              ...
              userParticipation?.is_completed ? 'bg-white/20' : 'bg-gray-100 dark:bg-white/5'}`
                ...
                userParticipation?.is_completed ? 'text-white' : 'text-[#0A1A2F] dark:text-white dark:text-white'}`
                }>
                    {challenge.title} Badge
                  </h4>
                  <p className={`text-sm ${
                userParticipation?.is_completed ? 'text-white/90' : 'text-[#0A1A2F]/60 dark:text-white/60'}`
                }>
                    {userParticipation?.is_completed ?
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}>
          <div className="bg-white dark:bg-white/5 rounded-xl p-6 shadow-sm dark:shadow-none border border-gray-200 dark:border-white/10 dark:border-white/10">
            ...
            <div className="text-center py-8">
                <Users className="w-12 h-12 text-[#0A1A2F]/30 dark:text-white/30 mx-auto mb-3" />
                <p className="text-[#0A1A2F]/60 dark:text-white/60 text-sm">No participants yet. Be the first to join!</p>
              </div> :
                ...
                className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-white/5 hover:bg-gray-100 dark:bg-white/5 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-xs text-[#0A1A2F]/60 dark:text-white/60">{participant.progress || 0}%</span>
                      </div>
                    </div>
                  </motion.div>
              )}
