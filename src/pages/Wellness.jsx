      ...
      <div className="px-4 pt-6">
        ...
        <Tabs defaultValue="workouts" className="w-full" onValueChange={setActiveTab}>
          <TabsList className={`grid w-full grid-cols-4 mb-6 p-1 rounded-xl ${activeTab === 'nutrition' ? 'bg-[#90EE90]' : activeTab === 'meditation' ? 'bg-purple-500' : 'bg-[#FD9C2D]'}`}>
            <TabsTrigger value="workouts" className={`text-xs sm:text-sm ${activeTab === 'nutrition' ? 'data-[state=active]:bg-[#FFFF00]' : activeTab === 'meditation' ? 'data-[state=active]:bg-pink-300' : 'data-[state=active]:bg-[#C4E3FD]'} data-[state=active]:text-black`}>Workouts</TabsTrigger>
            <TabsTrigger value="nutrition" className={`text-xs sm:text-sm ${activeTab === 'nutrition' ? 'data-[state=active]:bg-[#FFFF00]' : activeTab === 'meditation' ? 'data-[state=active]:bg-pink-300' : 'data-[state=active]:bg-[#C4E3FD]'} data-[state=active]:text-black`}>Nutrition</TabsTrigger>
            <TabsTrigger value="meditation" className={`text-xs sm:text-sm ${activeTab === 'nutrition' ? 'data-[state=active]:bg-[#FFFF00]' : activeTab === 'meditation' ? 'data-[state=active]:bg-pink-300' : 'data-[state=active]:bg-[#C4E3FD]'} data-[state=active]:text-black`}>Meditation</TabsTrigger>
            <TabsTrigger value="selfcare" className={`text-xs sm:text-sm ${activeTab === 'nutrition' ? 'data-[state=active]:bg-[#FFFF00]' : activeTab === 'meditation' ? 'data-[state=active]:bg-pink-300' : 'data-[state=active]:bg-[#C4E3FD]'} data-[state=active]:text-black`}>Self-Care</TabsTrigger>
          </TabsList>
