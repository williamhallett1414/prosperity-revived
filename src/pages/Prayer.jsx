...
const ACTS_STEPS = [
  ...
  { key: 'confession',   label: 'Confession',   emoji: '🕊️', color: '#60a5fa',
    prompt: 'Honestly name anything between you and God — a failing, a grudge, something you\'re carrying. He already knows and He already forgives. This isn\'t about shame — it\'s about freedom. "If we confess our sins, he is faithful and just and will forgive us." (1 John 1:9). Who do you also need to extend grace to — including yourself?',
