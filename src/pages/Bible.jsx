              ...
              <div className="space-y-6">
                ...
                className="bg-gradient-to-br from-[#AFC7E3] to-[#D9B878] rounded-2xl p-5 text-white">
                  ...
                  <div className="flex gap-2">
                    ...
                    variant="outline" className="bg-background text-slate-950 px-4 py-2 text-sm font-bold rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border shadow-sm hover:text-accent-foreground h-9 border-white/50 hover:bg-white/10 flex-1">
