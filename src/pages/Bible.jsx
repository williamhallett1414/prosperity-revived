...
function BibleInner() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F6FA] dark:bg-[#0A1A2F] pb-28">
      ...
      {/* ── Standard Header ── */}
      <div className="sticky top-0 z-30 bg-white dark:bg-[#0A1A2F] border-b border-[#FAD98D]/20 px-4 pt-4 pb-3">
      ...
      {/* Fixed tab menu */}
      <div id="tour-bible-tabs" className="sticky top-[48px] z-30 px-4 pt-4 pb-3 bg-white/95 dark:bg-[#0A1A2F]/95 backdrop-blur-sm border-b border-[#FAD98D]/15 dark:border-[#FAD98D]/8 max-w-lg mx-auto">
