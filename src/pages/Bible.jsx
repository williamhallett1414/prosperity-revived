  ...
  return (
    <div className="min-h-screen bg-[#F2F6FA] dark:bg-[#0A1A2F] pb-28">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div id="tour-bible-tabs" className="sticky top-0 z-30 px-4 pt-3 pb-3 bg-white/95 dark:bg-[#0A1A2F]/95 backdrop-blur-sm border-b border-[#FAD98D]/15 dark:border-[#FAD98D]/8 max-w-lg mx-auto">
