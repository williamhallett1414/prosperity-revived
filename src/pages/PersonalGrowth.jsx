  ...
  return (
    <div className="bg-white dark:bg-[#0A1A2F] pb-28">
      ...
      <motion.div
        ...
        className="mx-3 sm:mx-4 mb-3 flex items-center justify-center gap-2 bg-blue-50 dark:bg-blue-900/20 rounded-xl px-3 py-2 border border-blue-100 dark:border-blue-800/30"
      >
