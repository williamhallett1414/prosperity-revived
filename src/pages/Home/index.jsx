...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F6FA] dark:bg-[#0A1A2F]">
      ...
      {/* One-time celebration when the user has just been granted
          Founding Member status (set by claimFoundingMember backend
          function at end of onboarding). Reads localStorage flag, shows
          once, marks as shown. Safe to mount unconditionally. */}
      <FounderCelebration />
