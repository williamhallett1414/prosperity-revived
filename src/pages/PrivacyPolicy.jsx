          ...
          <ScrollArea className="h-[calc(100vh-200px)]">
            <div className="space-y-6 text-[#0A1A2F] dark:text-white pr-4">
              <div className="text-center mb-6">
                ...
                <h3 className="text-base font-semibold text-gray-600 dark:text-gray-300 mb-1">Prosperity Revived</h3>
              ...
              <div>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/30 rounded-xl p-3 mb-2">
