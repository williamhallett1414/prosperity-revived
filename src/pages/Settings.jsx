      ...
      <div className="px-4 pt-4">
        ...
        <div className="bg-white dark:bg-white/5 dark:bg-[#0A1A2F] rounded-2xl p-4 shadow-sm dark:shadow-none">
          ...
          <div className="space-y-3">
            ...
            {/* TEMP for App Store screenshot capture — remove when Phase 3
                wires the paywall into the real onboarding-completion flow.
                Marked (Dev) in amber so TestFlight testers don't mistake
                this for a real subscription entry point. */}
            <Link
              to={createPageUrl('Paywall')}
