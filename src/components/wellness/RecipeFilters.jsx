    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-9 py-2.5 rounded-xl bg-white dark:bg-white/5 border border-[#FAD98D]/25 dark:border-[#FAD98D]/10 dark:border-[#FAD98D]/5 text-sm text-[#0A1A2F] dark:text-white placeholder-[#0A1A2F]/35 focus:outline-none focus:border-[#c9a227]/50"
        />
        {filters.search && (
