    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-9 py-1.5 rounded-lg bg-white dark:bg-white/5 border border-[#FAD98D]/25 dark:border-white/10 text-sm text-[#0A1A2F] dark:text-white placeholder-[#0A1A2F]/35 focus:outline-none focus:border-[#c9a227]/50"
        />
        {filters.search && (
