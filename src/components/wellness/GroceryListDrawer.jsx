      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {/* Header */}
            <div className="px-5 py-3 border-b border-[#FAD98D]/20 dark:border-[#FAD98D]/10 dark:border-[#FAD98D]/5 flex items-center justify-between flex-shrink-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={onClose}
                  className="w-8 h-8 rounded-full bg-[#F2F6FA] dark:bg-[#0A1A2F] flex items-center justify-center text-[#0A1A2F]/50 dark:text-white/50 hover:bg-[#FAD98D]/20 dark:bg-[#FAD98D]/8">
                        ...
                        {items.map(item => (
                          <div key={item.id}
                            className={`flex items-start gap-3 p-3 rounded-xl border transition-all ${
                              item.checked
                                ? 'bg-[#F2F6FA] dark:bg-[#0A1A2F] border-[#FAD98D]/15 dark:border-[#FAD98D]/8 opacity-60'
                                : 'bg-white dark:bg-white/5 border-[#FAD98D]/20 dark:border-[#FAD98D]/10 dark:border-[#FAD98D]/5'
                            }`}>
                            {/* Checkbox */}
                            <button onClick={() => toggleItem(item.id)}
                              className={`w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0 mt-0.5 transition-colors ${
                                item.checked
                                  ...
                                  : 'border-[#FAD98D]/50 dark:border-[#FAD98D]/20 hover:border-[#c9a227]'
                              }`}>
