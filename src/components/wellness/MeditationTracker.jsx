    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-[#AFC7E3] to-[#AFC7E3] rounded-xl p-4 text-white"
        >
          <div className="flex items-center gap-2 mb-2">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-[#c9a227] to-[#FAD98D] rounded-xl p-4 text-white"
        >
          <div className="flex items-center gap-2 mb-2">
            <Clock className="w-5 h-5" />
