...
export default function GratitudeAIPrompt({ prompt, loading, onRefresh }) {
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-[#FD9C2D]/10 to-[#FAD98D]/10 rounded-2xl border border-[#FAD98D]/30 p-5"
    >
      ...
      {loading ? (
        <div className="space-y-2 mt-3">
          <div className="h-3 bg-[#FAD98D]/20 rounded-full w-full animate-pulse" />
