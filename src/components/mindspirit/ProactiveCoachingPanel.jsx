  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <div className="bg-white dark:bg-white/5 rounded-lg p-4 border border-[#FAD98D]/30 dark:border-[#FAD98D]/10 dark:border-[#FAD98D]/5">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          <div className="bg-white dark:bg-white/5 p-3 rounded-lg border border-[#FAD98D]/30 dark:border-[#FAD98D]/10 dark:border-[#FAD98D]/5">
