    ...
    <div className="relative inline-block group">
      ...
      <AnimatePresence>
        {isVisible && (
          ...
          >
            <div className="bg-[#FAD98D]/20 text-[#0A1A2F] text-xs rounded-lg px-3 py-2 max-w-xs whitespace-normal shadow-lg border border-[#FAD98D]/40">
              {text}
            </div>
            <div
              className={`absolute w-2 h-2 bg-[#FAD98D]/20 border border-[#FAD98D]/40 ${arrowClasses[position]}`}
            />
          </motion.div>
        )}
      </AnimatePresence>
