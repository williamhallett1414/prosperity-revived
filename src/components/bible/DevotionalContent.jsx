  ...
  return (
    <div className="space-y-4">
      <motion.div
        ...
        className="mb-4"
      >
        <h2 className="text-xl font-bold text-[#0A1A2F] dark:text-white mb-1">Featured Devotionals</h2>
        <p className="text-sm text-[#0A1A2F]/55 dark:text-white/55">Deep dive articles on faith and spiritual growth</p>
      </motion.div>
