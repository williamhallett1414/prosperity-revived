...
export default function GideonNotificationSettings() {
  ...
  return (
    <Card className="bg-gradient-to-br from-[#FAD98D]/10 to-[#FFF9EC] dark:to-[#FAD98D]/5 dark:from-[#0A1A2F]/40 dark:to-[#0A1A2F]/40 border-[#FAD98D]/40 dark:border-[#FAD98D]/15 dark:border-[#FAD98D]/8 dark:border-[#c9a227]/40">
      <CardHeader>
                ...
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <p className="font-medium text-gray-900 dark:text-white">{option.title}</p>
                      {option.badge && (
                        <span className="px-2 py-0.5 bg-[#FAD98D]/20 dark:bg-[#FAD98D]/8 dark:bg-[#FAD98D]/10 dark:bg-[#FAD98D]/5 text-[#C9A227] dark:text-[#c9a227] text-xs font-semibold rounded-full">
                          {option.badge}
                        </span>
                      )}
                    </div>
