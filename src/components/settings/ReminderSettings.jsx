  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-[#0A1A2F] dark:text-white dark:text-white">Daily Reminders</h3>
      </div>
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <p className="font-medium text-[#0A1A2F] dark:text-white dark:text-white">{label}</p>
            </div>
            <Button
              size="sm"
