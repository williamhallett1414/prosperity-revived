...
const FACE_CONFIG = {
  gideon: {
    leftEyeX: 0.38,  leftEyeY: 0.52,
    rightEyeX: 0.52, rightEyeY: 0.52,
    eyeW: 0.085, eyeH: 0.030,
    eyeColor: '#5C3A20',
    mouthX: 0.40, mouthY: 0.62,
    mouthW: 0.18, mouthMaxH: 0.040,
    mouthColor: '#1A0500',
  },
  hannah: {
    leftEyeX: 0.37,  leftEyeY: 0.44,
    rightEyeX: 0.51, rightEyeY: 0.44,
    eyeW: 0.085, eyeH: 0.028,
    eyeColor: '#5A3520',
    mouthX: 0.40, mouthY: 0.53,
    mouthW: 0.17, mouthMaxH: 0.036,
    mouthColor: '#150400',
  },
  coach: {
    leftEyeX: 0.38,  leftEyeY: 0.35,
    rightEyeX: 0.51, rightEyeY: 0.35,
    eyeW: 0.080, eyeH: 0.026,
    eyeColor: '#4A2810',
    mouthX: 0.40, mouthY: 0.44,
    mouthW: 0.16, mouthMaxH: 0.034,
    mouthColor: '#0E0200',
  },
  chef: {
    leftEyeX: 0.37,  leftEyeY: 0.58,
    rightEyeX: 0.51, rightEyeY: 0.58,
    eyeW: 0.090, eyeH: 0.030,
    eyeColor: '#4A2810',
    mouthX: 0.39, mouthY: 0.67,
    mouthW: 0.19, mouthMaxH: 0.040,
    mouthColor: '#120300',
  },
  paul: {
    leftEyeX: 0.35,  leftEyeY: 0.40,
    rightEyeX: 0.49, rightEyeY: 0.40,
    eyeW: 0.095, eyeH: 0.030,
    eyeColor: '#3E2008',
    mouthX: 0.38, mouthY: 0.49,
