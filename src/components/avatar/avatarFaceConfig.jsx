...
const FACE_CONFIG = {
  gideon: {
    leftEyeX: 0.38,  leftEyeY: 3.43,
    rightEyeX: 0.52, rightEyeY: 3.43,
    eyeW: 0.085, eyeH: 0.030,
    eyeColor: '#5C3A20',
    mouthX: 0.40, mouthY: 3.54,
    mouthW: 0.18, mouthMaxH: 0.040,
    mouthColor: '#1A0500',
  },
  hannah: {
    leftEyeX: 0.37,  leftEyeY: 3.36,
    rightEyeX: 0.51, rightEyeY: 3.36,
    eyeW: 0.085, eyeH: 0.028,
    eyeColor: '#5A3520',
    mouthX: 0.40, mouthY: 3.46,
    mouthW: 0.17, mouthMaxH: 0.036,
    mouthColor: '#150400',
  },
  coach: {
    leftEyeX: 0.38,  leftEyeY: 3.26,
    rightEyeX: 0.51, rightEyeY: 3.26,
    eyeW: 0.080, eyeH: 0.026,
    eyeColor: '#4A2810',
    mouthX: 0.40, mouthY: 3.36,
    mouthW: 0.16, mouthMaxH: 0.034,
    mouthColor: '#0E0200',
  },
  chef: {
    leftEyeX: 0.37,  leftEyeY: 3.45,
    rightEyeX: 0.51, rightEyeY: 3.45,
    eyeW: 0.090, eyeH: 0.030,
    eyeColor: '#4A2810',
    mouthX: 0.39, mouthY: 3.55,
    mouthW: 0.19, mouthMaxH: 0.040,
    mouthColor: '#120300',
  },
  paul: {
    leftEyeX: 0.35,  leftEyeY: 3.32,
    rightEyeX: 0.49, rightEyeY: 3.32,
    eyeW: 0.095, eyeH: 0.030,
    eyeColor: '#3E2008',
    mouthX: 0.38, mouthY: 3.42,
