          ...
          {displayChallenges.map((challenge, index) => {
            ...
            return (
              <motion.button
                ...
                className={`w-full bg-gradient-to-r ${challenge.gradient} rounded-2xl p-5 text-white shadow-lg text-left`}
              >
                ...
                {isParticipating ? (
                  <>
                    <Progress value={progress.percentage} className="mb-2 bg-white/20" />
                  ...
                  <p className="text-sm opacity-90 mt-2">{challenge.duration} days • Tap to start</p>
                )}
              </motion.button>
            );
          })}
