          ...
          return (
            <Link key={action.label} to={createPageUrl(action.page)}>
              <motion.button
                ...
                className={`flex flex-col items-center gap-1 px-4 py-3 rounded-lg bg-gradient-to-br ${action.color} text-[#0A1A2F] dark:text-white min-w-[70px] snap-start flex-shrink-0 shadow-sm dark:shadow-none`}
              >
