      ...
      <div className="space-y-3 px-4">
        {recommendations.map((rec, index) => (
          <motion.button
            ...
            onClick={rec.action}
            className={`w-full text-left bg-gradient-to-r ${rec.color} rounded-2xl p-4 shadow-sm dark:shadow-none hover:shadow-md dark:shadow-none transition-shadow border border-gray-100 dark:border-white/10 dark:border-white/10/50`}
          >
