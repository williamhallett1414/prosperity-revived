...
import { Camera, MessageCircle, UserPlus, Sparkles } from 'lucide-react';
        ...
        <motion.div
          ...
          className="border-t border-gray-200 dark:border-white/10 pt-4 pb-3">
            ...
            <p className="text-gray-700 dark:text-gray-200 text-center sm:text-left mb-3 italic text-sm sm:text-base">
              ...
              {user?.spiritual_goal &&
            <div className="flex items-start gap-2.5 text-sm bg-gradient-to-br from-[#FAD98D]/20 to-[#AFC7E3]/20 border border-[#FAD98D]/40 dark:border-[#FAD98D]/15 dark:border-[#FAD98D]/8 rounded-lg p-3">
