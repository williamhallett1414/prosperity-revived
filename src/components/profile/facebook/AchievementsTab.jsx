...
export default function AchievementsTab({ userProgress }) {
  ...
  return (
    ...
    >
      {/* Level & Points Card */}
      <div className="bg-gradient-to-br from-[#FAD98D]/20 via-[#FAD98D]/10 to-[#FFF8E7] rounded-xl shadow-sm p-6 sm:p-8 border border-[#D9B878]/40">
        <div className="grid grid-cols-3 gap-4 sm:gap-6">
          <div className="text-center">
            <div className="text-3xl sm:text-5xl font-bold text-[#c9a227] mb-2">{userProgress.level || 1}</div>
            <p className="text-xs sm:text-sm font-semibold text-[#0A1A2F]/75">Level</p>
          </div>
          <div className="text-center">
            <div className="text-3xl sm:text-5xl font-bold text-[#D9B878] mb-2">{userProgress.total_points || 0}</div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-[#D9B878]/25">
        ...
        <div className="w-full bg-[#D9B878]/20 rounded-full h-4 overflow-hidden">
          <motion.div
            initial={{ width: 0 }}
            animate={{ width: `${Math.min((userProgress.total_points % 1000) / 10, 100)}%` }}
            transition={{ duration: 1, ease: "easeOut" }}
            className="bg-gradient-to-r from-[#c9a227] via-[#D9B878] to-[#FAD98D] h-4 rounded-full shadow-inner"
          />
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-[#D9B878]/25">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4">
            {userProgress.badges.map((badge, index) => (
              ...
              >
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-[#c9a227] via-[#D9B878] to-[#FAD98D] flex items-center justify-center text-2xl sm:text-3xl shadow-lg group-hover:shadow-xl group-hover:scale-105 transition-all">
                  🏅
                </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-[#D9B878]/25">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex items-center justify-between p-4 bg-[#FAD98D]/10 rounded-lg border border-[#D9B878]/25">
      ...
      {(userProgress.current_streak > 0 || userProgress.longest_streak > 0) && (
        <div className="bg-gradient-to-br from-[#FAD98D]/20 via-[#FAD98D]/10 to-[#FFF8E7] rounded-xl shadow-sm p-6 border border-[#D9B878]/25">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col items-center p-5 bg-white rounded-lg border border-[#D9B878]/25">
