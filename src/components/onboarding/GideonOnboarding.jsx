...
import { ChevronRight, BookOpen, HelpCircle, X } from 'lucide-react';
          ...
          >
            ...
            <div className="p-6 bg-gray-50 dark:bg-white/5 border-t border-gray-100 dark:border-white/10 space-y-3">
              <div className="flex gap-3">
                <Button
                  onClick={handleNext}
                  className="w-full bg-gradient-to-r from-[#c9a227] to-[#FAD98D] hover:from-[#C9A227] hover:to-[#c9a227] text-white flex items-center justify-center gap-2"
                >
