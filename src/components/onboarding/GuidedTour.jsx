...
export const TOUR_STEPS = [
  {
    id: 'intro',
    targetId: null,
    title: "Let's walk through the app 🗺️",
    body: "I'll highlight key features one by one. Tap the glowing element on screen to interact with it, or press Next to move along. Takes about 2 minutes.",
    tip: null,
    tapToAdvance: false,
    navigateTo: 'Home',
    showArrow: false,
  ...
  },
  {
    ...
    title: 'Community 👥',
    body: 'Tap Community to join groups, post wins in the feed, encourage others, and stay accountable together.',
    tip: null,
    tapToAdvance: true,
  ...
  },
  {
    ...
    title: 'Join a Group 🤝',
    body: 'Groups are the heart of accountability. Join a Bible study, workout circle, or prayer group and follow the same journey together.',
  ...
  },
  {
    ...
    body: 'Tap Profile to see your full progress — workouts logged, mood trends, habit streaks, journal entries, and achievements.',
    tip: null,
    tapToAdvance: true,
    navigateTo: 'Profile',
    showArrow: true,
  ...
  {
    id: 'profile_progress',
    targetId: 'tour-profile-progress',
    title: 'Your Progress Report 📈',
    body: "This shows your holistic progress across every part of the app — one view for your whole journey.",
    tip: 'Earn achievement badges as you hit milestones and streaks',
    tapToAdvance: false,
    navigateTo: null,
    showArrow: true,
  },
  {
    ...
    body: "Every feature is personalized around your goals. Your 4 AI coaches — Hannah, Gideon, Coach David, and Chef Daniel — are always just a tap away.",
    tip: 'Replay this tour anytime from Settings → Replay Guided Tour',
    tapToAdvance: false,
    navigateTo: null,
    showArrow: false,
    isDone: true,
