              ...
              <div className="px-5 py-4 space-y-4 max-h-[60vh] overflow-y-auto">
                ...
                {cfg.id==='fitness' && (
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <NumberInput label="Current lbs" value={d.weight_lbs} onChange={v=>set('weight_lbs',v)} min={80} max={500} unit="lbs" />
                      <NumberInput label="Goal lbs" value={d.goal_weight_lbs} onChange={v=>set('goal_weight_lbs',v)} min={80} max={500} unit="lbs" />
                    </div>
