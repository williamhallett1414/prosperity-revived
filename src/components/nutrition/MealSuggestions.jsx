...
export default function MealSuggestions() {
  ...
  return (
    <motion.div
      ...
      className="px-4 mb-6"
    >
      <h2 className="text-lg font-bold text-[#0A1A2F] dark:text-white mb-3">Suggested Meals</h2>
        ...
        {suggestedMeals.map((meal, idx) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-semibold text-[#0A1A2F] dark:text-white truncate">{meal.name}</h3>
              <div className="flex gap-3 mt-1 text-xs text-[#0A1A2F]/60 dark:text-white/60">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-[#c9a227] to-[#FAD98D] hover:opacity-90 text-white h-8"
            >
