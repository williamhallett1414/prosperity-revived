    ...
    <div className="space-y-4 mb-6 px-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-gray-100 border-0 rounded-lg text-[#0A1A2F] placeholder-[#0A1A2F]/40 focus:ring-2 focus:ring-[#FAD98D]"
        />
      </div>
        ...
        {categories.map((cat, idx) => (
          <motion.button
            ...
            className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-all ${
              activeCategory === cat
                ? 'bg-gradient-to-r from-[#FAD98D] to-[#AFC7E3] text-[#0A1A2F] shadow-md'
