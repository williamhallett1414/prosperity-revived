...
const categories = [
  { id: 'strength', label: 'Strength', icon: Dumbbell, color: 'from-[#FAD98D] to-[#FD9C2D]' },
  { id: 'cardio', label: 'Cardio', icon: Zap, color: 'from-[#FD9C2D] to-[#FAD98D]' },
  { id: 'mobility', label: 'Mobility', icon: Wind, color: 'from-[#AFC7E3] to-[#FAD98D]' },
  { id: 'beginner', label: 'Beginner', icon: Flame, color: 'from-[#FAD98D] to-[#AFC7E3]' },
          ...
          <motion.button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg min-w-fit snap-start transition-all ${
              activeCategory === cat.id
                ...
                : 'bg-gray-100 text-[#0A1A2F]/70 hover:bg-gray-100/80'
            }`}
          >
