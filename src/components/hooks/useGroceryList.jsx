...
// Categorise an ingredient string
...
// Parse a recipe's ingredients into flat grocery items
...
// Singleton state shared across hook instances via module-level variables
let _list = loadList();
...
export function useGroceryList() {
  ...
  // Subscribe on first render (runs once thanks to useCallback identity)
  // We use a simple trick: store cleanup in a ref-like pattern
  useState(() => subscribe());
