...
import { UtensilsCrossed, Check, Info, ChevronRight, Loader2 } from 'lucide-react';
      ...
      {!selectedSource ? (
        ...
        <div className="space-y-4">
          ...
          <textarea
            ...
            className="w-full text-sm border border-gray-200 dark:border-white/10 rounded-xl p-3 h-36 resize-none focus:outline-none focus:ring-2 focus:ring-green-300"
          />
