...
- priority: 1-10 score`;
  ...
  if (loading) {
    return (
      <div style={{ background: 'var(--color-background)' }} className="rounded-2xl p-6 mb-6 border border-[#FAD98D]/40 dark:border-[#FAD98D]/15 dark:border-[#FAD98D]/8 dark:border-[#FAD98D]/20 dark:border-[#FAD98D]/10 dark:border-[#FAD98D]/5">
        ...
        {recommendations.slice(0, 3).map((rec, index) => {
          ...
          return (
            <motion.div
              ...
              className="rounded-xl p-4 border border-[#FAD98D]/40 dark:border-[#FAD98D]/15 dark:border-[#FAD98D]/8 dark:border-[#FAD98D]/20 dark:border-[#FAD98D]/10 dark:border-[#FAD98D]/5 shadow-sm dark:shadow-none"
            >
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-full bg-[#FAD98D]/20 dark:bg-[#FAD98D]/8 dark:bg-[#FAD98D]/10 dark:bg-[#FAD98D]/5 flex items-center justify-center flex-shrink-0">
